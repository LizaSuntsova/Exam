...
namespace ExamProject
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            new Client("Семенов Тимур Андреевич", Sex.Male, 48, new DateTime(2020, 12, 25)),
            new Client("Петухова Анна Геннадьевна", Sex.Female, 27, new DateTime(2020, 12, 29)),
            new Client("Петров Егор Николаевич", Sex.Male, 35, new DateTime(2020, 12,30)),
            new Client("Сунцова Елизавета Александровна", Sex.Female, 20, new DateTime(2020, 12, 29)),
            };
